package com.danisestan.checkmate.ReportUtils;

import java.io.*;
import java.util.ArrayList;

import com.danisestan.checkmate.Utils.*;
...
public class ReportUtil {
	...
	public static ArrayList<String> stepIDstr = new ArrayList<String>();
	...
	public static ArrayList<String> statDetails = new ArrayList<String>();
	...
	public static void startTesting(String filename, String testStartTime, String env, String rel) {
		...
		try {
			...
			out.write("<html>\n");
			out.write("<HEAD>\n");
			out.write(" <TITLE>Automation TestAutomation Results</TITLE>\n");
			out.write("</HEAD>\n");

			out.write("<body>\n");
			out.write("<h4 align=center><FONT COLOR=660066 FACE=AriaL SIZE=6><b><u> Automation TestAutomation Results</u></b></h4>\n");
			out.write("<table  border=1 cellspacing=1 cellpadding=1 >\n");
			out.write("<tr>\n");

			out.write("<h4> <FONT COLOR=660000 FACE=Arial SIZE=4.5> <u>TestAutomation Details :</u></h4>\n");
			 ...
			 * "<td width=80  align= center  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>TestAutomation Script#</b></td>"
			 * );
			 * 
			 * out.write(
			 * "<td width=300 align= center  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>TestAutomation Case Name</b></td>"
			 * ); out.write(
	...
	public static void startSuite(String suiteName) {
		...
		try {
			...
			out.write("<tr>\n");
			out.write("<td width=10%  align= center  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>TestAutomation Script#</b></td>\n");

			out.write("<td width=40% align= center  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>TestAutomation Case Name</b></td>\n");
	...
	public static void addTestCase(String testCaseName, String testCaseStartTime, String testCaseEndTime, String status) {
		...
		try {
			...
			if (status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip")) {
				...
				out.write("<table  border=1 cellspacing=1    cellpadding=1 width=100%>");
				out.write("<tr> ");
				out.write("<td align=center width=5% align=center " + "bgcolor=#153E7E><FONT COLOR=#E0E0E0 " +
                        "FACE=Arial " + "SIZE=2><b>Step Number</b></td>");
				out.write("<td align=center width=5%  align=center " + "bgcolor=#153E7E><FONT COLOR=#E0E0E0 " +
                        "FACE=Arial " + "SIZE=2><b>Step ID</b></td>");
				out.write("<td align=center width=40% align=center " + "bgcolor=#153E7E><FONT COLOR=#E0E0E0 " +
                        "FACE=Arial SIZE=2><b>Description</b></td>");
				out.write("<td align=center width=10% align=center bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial " +
                        "SIZE=2><b>Keyword</b></td>");
				out.write("<td align=center width=15% align=center bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial " +
                        "SIZE=2><b>Result</b></td>");
				out.write("<td align=center width=15% align=center bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial " +
                        "SIZE=2><b>Screen Shot</b></td>");
				out.write("</tr>");
				if (description != null) {
					int stepNum = 0;
					for (int i = 0; i < description.size(); i++) {
						out.write("<tr> ");
                        if (!teststatus.get(i).equalsIgnoreCase ("Skipped Step")) {
                            out.write("<td align=center width=5%><FONT " + "COLOR=#153E7E FACE=Arial SIZE=1><b># " +
                                    ++stepNum + "</b></td>");
                        }
                        else {
                            out.write("<td align=center bgcolor=Grey width=5%><FONT " + "COLOR=#153E7E FACE=Arial " +
                                    "SIZE=1><b>SKIP</b></td>");
                        }
						out.write("<td align=center width=5%><FONT " + "COLOR=#153E7E FACE=Arial SIZE=1><b>" +
                                stepIDstr.get(i).substring(0, stepIDstr.get(i).indexOf(".")) + "</b></td>");
						out.write("<td align=center width=40%><FONT " +  "COLOR=#153E7E FACE=Arial SIZE=1><b>" +
                                description.get(i) + "</b></td>");
						out.write("<td align=center width=10%><FONT COLOR=#153E7E FACE=Arial SIZE=1><b>" + keyword
                                .get(i) + "</b></td>");
						if (teststatus.get(i).equalsIgnoreCase("Pass"))
							out.write("<td width=15% align= center  " +
                                    "bgcolor=#BCE954><FONT COLOR=#153E7E FACE=Arial SIZE=2><b>" + teststatus.get(i) + "</b></td>\n");
						else if (teststatus.get(i).equalsIgnoreCase("Failed"))
							out.write("<td width=15% align= center  " +
                                    "bgcolor=Red><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b>" + teststatus.get(i) + "</b></td>\n");
                        else if (teststatus.get(i).equalsIgnoreCase("Skipped Step")) out.write("<td width=15%" +
                                " align= center  " +  "bgcolor=Grey><FONT COLOR=#153E7E FACE= " +  "Arial  " +
                                "SIZE=2><b>" + teststatus.get(i) + "</b></td>\n");
						if (screenShotPath.get(i) != null)
							out.write("<td align=center width=15%><FONT " + "COLOR=#153E7E FACE=Arial " +
                                    "SIZE=1><b><a href=" + screenShotPath.get(i) + " target=_blank>Screen Shot</a></b></td>");
						else
							out.write("<td align=center width=15%><FONT " + "COLOR=#153E7E FACE=Arial " +
                                    "SIZE=1><b>&nbsp;</b></td>");
						out.write("</tr>");
		...
		stepIDstr = new ArrayList<String>();
		description = new ArrayList<String>();
		keyword = new ArrayList<String>();
		teststatus = new ArrayList<String>();
		statDetails = new ArrayList<String>();
		screenShotPath = new ArrayList<String>();
		newTest = false;
	}

	public static void addKeyword(String id, String desc, String key, String
			stat, String statDetails, String path) {
		stepIDstr.add(id);
		description.add(desc);
		keyword.add(key);
		teststatus.add(stat);
		teststatus.add(statDetails);

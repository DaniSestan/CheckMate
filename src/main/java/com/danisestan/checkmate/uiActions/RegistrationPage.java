package com.danisestan.checkmate.uiActions;
...
public class RegistrationPage extends Resources {
	...
	public String selectDaysInDropDown() throws Exception{
		try {
			...
			tsDetails = "Failed - unable to select day in dropdown";
		}
	...
	public String selectMonthInDropDown() throws Exception{
		try {
			...
			tsDetails = "Failed - unable to select month in dropdown";
			return "Failed";
		}
		tsDetails = ""; 		return "Pass";
	}
	...
	public String selectYearInDropDown() throws Exception{
		try {
			...
			tsDetails = "Failed - unable to select year in dropdown";
			return "Failed";
		}
		tsDetails = ""; 		return "Pass";
	}
	...
	public String selectYourAddressCountry() throws Exception{
		try {
			...
			tsDetails = "Failed - unable to select country in dropdown";
			return "Failed";
		}
		tsDetails = ""; 		return "Pass";
	}
